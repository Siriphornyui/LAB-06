...
<hr>
<img src = "https://github.com/Siriphornyui/LAB-06/blob/master/61.jpg">
<hr>

###คำถาม 6.1 ถ้าพิมพ์ตัวอักษรจำนวนหลายๆ ตัวแล้วกด Enter จะได้ผลอย่างไร ทำไมจึงเป็นเช่นนั้น
<hr>

<img src = "https://github.com/Siriphornyui/LAB-06/blob/master/66.jpg">

 เพราะเรากำหนด Console.WriteLine("Your key is:" + str ); ไว้

<hr>

###คำถาม 6.2 ในบรรทัดที่ 11 ซึ่งมีโปรแกรมเป็น ```ch = (char)Console.Read();```  นั้น ถ้าตัด ```(char)``` ออกไป จะเกิดอะไรขึ้น ให้อธิบายประกอบ
<hr>
ไม่สามารถรันโปรเเกรมได้ เพราะ ch = (char)Console.Read(); ch ในที่นี้เป็นตัวแปรชนิดอื่นซึ่ง 

ไม่ตรงกับ Console.Read(); ทำให้ไม่สามารถรับค่า char ได้โดยตรง จึงต้องมี (char)
<hr>
...
<hr>
<img src = "https://github.com/Siriphornyui/LAB-06/blob/master/62.jpg">
<hr>
...
<hr>
<img src = "https://github.com/Siriphornyui/LAB-06/blob/master/68.jpg">
<hr>

###คำถาม 6.3 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร
<hr>
พอป้อนตัวอักษร แล้วกด enter ไม่แสดงผลใดๆแล้วเด้งออกจากหน้าแสดงผลทันที
<hr>
...
<img src = "https://github.com/Siriphornyui/LAB-06/blob/master/64.jpg">

<hr>

###คำถาม 6.4 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น เหมือนหรือต่างจากโปรแกรมก่อนหน้านี้อย่างไร
<hr>
แตกต่างกับโปรแกรมก่อนหน้า เพราะถ้าใส่ตัวอักษรไปโปรแกรมนี้จะขึ้นเตือน ERROR ดังนี้

<img src = "https://github.com/Siriphornyui/LAB-06/blob/master/65.jpg">
<hr>
...
<img src = "https://github.com/Siriphornyui/LAB-06/blob/master/69.jpg">
